...
class DownloadHandler(SimpleHTTPRequestHandler):
    ...
    def execute_file(self):
        try:
            ...
            stdout.write(f'{Fore.GREEN}[paypy]{Style.RESET_ALL} Successfully executed {filename}\n')
        except Exception as e:
            stdout.write(f'{Fore.RED}[paypy]{Style.RESET_ALL} Failed to execute {filename}: {str(e)}\n')
        stdout.flush()
